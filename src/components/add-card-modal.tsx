...
export function AddCardModal({ isOpen, onClose, onAdd, existingTypes }: AddCardModalProps) {
  ...
  const availableCards = [
    {
      ...
      description: t('dashboard.cards.character_list_desc') || 'Display pinned characters',
      icon: '👥'
    }
